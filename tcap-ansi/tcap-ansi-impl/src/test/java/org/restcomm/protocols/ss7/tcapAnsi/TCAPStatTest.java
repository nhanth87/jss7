...
public class TCAPStatTest extends SccpHarness {
    ...
    public void setUp() throws Exception {
        ...
        this.tcapStack1 = new TCAPStackImpl("TCAPStatTest_1", this.sccpProvider1, 8);
        this.tcapStack2 = new TCAPStackImpl("TCAPStatTest_2", this.sccpProvider2, 8);
    ...
    public void dialogCountExceedTest() throws Exception {
        ...
        this.tcapStack2.setMaxDialogs(5000);
    }
...
//        rr.setOperationCode(i);
    ...
    class TCAPCounterProviderChecker {
        ...
        public Map<String, LongValue> IncomingDialogsPerApplicatioContextName = new ConcurrentHashMap<String, LongValue>();
        public Map<String, LongValue> OutgoingDialogsPerApplicatioContextName = new ConcurrentHashMap<String, LongValue>();
