...
public abstract class OctetStringBase implements MAPAsnPrimitive {
     ...
     * this octet string. Used by the BerCursor decode path, which navigates a snapshot
     * of the inbound buffer; the value is copied out so it does not alias that buffer.
     */
    public void setData(byte[] backing, int offset, int length) {
        this.data = Arrays.copyOfRange(backing, offset, offset + length);
    }
    ...
    public void encodeData(AsnOutputStream asnOutputStream) throws MAPException {
        ...
        if (d.length < this.minLength || d.length > this.maxLength)
