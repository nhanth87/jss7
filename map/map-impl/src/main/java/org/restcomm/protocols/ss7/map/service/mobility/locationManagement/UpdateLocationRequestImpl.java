    ...
    public void encodeData(AsnOutputStream asnOutputStream) throws MAPException {
        try {
            ...
            if (this.mscNumber != null)
                ((ISDNAddressStringImpl) this.mscNumber).encodeAll(asnOutputStream, Tag.CLASS_CONTEXT_SPECIFIC, _TAG_mscNumber);
            else
                ((ISDNAddressStringImpl) this.roamingNumber).encodeAll(asnOutputStream, Tag.CLASS_CONTEXT_SPECIFIC, _TAG_roamingNumber);
