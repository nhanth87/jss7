...
import org.restcomm.protocols.ss7.map.api.service.mobility.subscriberInformation.UtranCgi;
 ...
 */
@JacksonXmlRootElement(localName = "utranCgiImpl")
public class UtranCgiImpl extends OctetStringBase implements UtranCgi {
    ...
    public UtranCgiImpl(byte[] data) {
        super(7, 7, "UtranCgi", data);
    }
    ...
    public int getMCC() throws Exception {
        ...
        try {
            ...
            throw new IOException("IOException when decoding UtranCgi: " + e.getMessage(), e);
        } catch (Exception e) {
            throw new Exception("Parsing Component Exception when decoding UtranCgi: " + e.getMessage(), e);
        }
    ...
    public String toString() {
        ...
        try {
            try {
                ...
                logger.error("Exception while retrieving MCC/MNC at the toString method of UtranCgiImpl: " + e.getMessage());
            }
            uci = this.getUci();
            correctData = true;
        } catch (MAPException e) {
            logger.error("Exception while retrieving UCI at the toString method of UtranCgiImpl: " + e.getMessage());
        }
