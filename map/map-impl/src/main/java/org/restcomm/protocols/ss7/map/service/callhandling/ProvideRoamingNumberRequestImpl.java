...
public class ProvideRoamingNumberRequestImpl extends CallHandlingMessageImpl implements ProvideRoamingNumberRequest {
    ...
    public void encodeData(AsnOutputStream asnOutputStream) throws MAPException {
        ...
        if (this.mscNumber != null) {
            ((ISDNAddressStringImpl) this.mscNumber).encodeAll(asnOutputStream, Tag.CLASS_CONTEXT_SPECIFIC, TAG_mscNumber);
        }
        ...
        // 4
        if (this.lmsi != null) {
            ((LMSIImpl) this.lmsi).encodeAll(asnOutputStream, Tag.CLASS_CONTEXT_SPECIFIC, TAG_lmsi);
        }
        ...
        if (mapProtocolVersion >= 3) {
            ...
            if (this.gmscAddress != null) {
                ((ISDNAddressStringImpl) this.gmscAddress).encodeAll(asnOutputStream, Tag.CLASS_CONTEXT_SPECIFIC, TAG_gmscAddress);
            }
            ...
            if (this.alertingPattern != null) {
                ((AlertingPatternImpl) this.alertingPattern).encodeAll(asnOutputStream, Tag.CLASS_CONTEXT_SPECIFIC, TAG_alertingPattern);
            }
            ...
            if (this.supportedCamelPhasesInInterrogatingNode != null) {
                ((SupportedCamelPhasesImpl) this.supportedCamelPhasesInInterrogatingNode).encodeAll(asnOutputStream,
            ...
            if (this.orNotSupportedInGMSC) {
                ...
                try {
                    asnOutputStream.writeNull(Tag.CLASS_CONTEXT_SPECIFIC, TAG_orNotSupportedInGMSC);
                } catch (IOException e) {
            ...
            if (this.suppressVtCsi) {
                // suppressVtCsi
                try {
                    asnOutputStream.writeNull(Tag.CLASS_CONTEXT_SPECIFIC, TAG_suppressVtCsi);
                } catch (IOException e) {
            ...
            if (this.offeredCamel4CSIsInInterrogatingNode != null) {
                ((OfferedCamel4CSIsImpl) this.offeredCamel4CSIsInInterrogatingNode).encodeAll(asnOutputStream,
            ...
            if (this.pagingArea != null) {
                ((PagingAreaImpl) this.pagingArea).encodeAll(asnOutputStream, Tag.CLASS_CONTEXT_SPECIFIC, TAG_pagingArea);
            }
            ...
            if (this.mtrfIndicator) {
                // mtrfIndicator
                try {
                    asnOutputStream.writeNull(Tag.CLASS_CONTEXT_SPECIFIC, TAG_mtrfIndicator);
                } catch (IOException e) {
            ...
            if (this.oldMSCNumber != null) {
                ((ISDNAddressStringImpl) this.oldMSCNumber).encodeAll(asnOutputStream, Tag.CLASS_CONTEXT_SPECIFIC, TAG_oldMSCNumber);
            }
        }
