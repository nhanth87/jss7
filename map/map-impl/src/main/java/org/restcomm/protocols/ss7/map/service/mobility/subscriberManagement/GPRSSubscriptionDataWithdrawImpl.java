...
public class GPRSSubscriptionDataWithdrawImpl implements GPRSSubscriptionDataWithdraw, MAPAsnPrimitive {
    ...
    public void encodeData(AsnOutputStream asnOutputStream) throws MAPException {
        ...
        try {
            if (this.allGPRSData == false && this.contextIdList == null)
                throw new MAPException("Error while encoding the " + _PrimitiveName + ": no choice is defined");
            if (this.allGPRSData == true && this.contextIdList != null)
