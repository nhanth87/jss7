...
public class VlrCamelSubscriptionInfoImpl extends SequenceBase implements VlrCamelSubscriptionInfo {
    ...
    public void encodeData(AsnOutputStream asnOutputStream) throws MAPException {
        ...
        try {
            if (this.oCsi != null)
                ((OCSIImpl) this.oCsi).encodeAll(asnOutputStream, Tag.CLASS_CONTEXT_SPECIFIC, _TAG_oCsi);
            if (this.extensionContainer != null)
                ((MAPExtensionContainerImpl) this.extensionContainer).encodeAll(asnOutputStream, Tag.CLASS_CONTEXT_SPECIFIC,
                        _TAG_extensionContainer);
            if (this.ssCsi != null)
                ((SSCSIImpl) this.ssCsi).encodeAll(asnOutputStream, Tag.CLASS_CONTEXT_SPECIFIC, _TAG_ssCsi);
            if (this.oBcsmCamelTDPCriteriaList != null) {
                asnOutputStream.writeTag(Tag.CLASS_CONTEXT_SPECIFIC, false, _TAG_oBcsmCamelTDPCriteriaList);
            ...
            if (this.tifCsi)
                asnOutputStream.writeNull(Tag.CLASS_CONTEXT_SPECIFIC, _TAG_tifCsi);
            if (this.mCsi != null)
                ((MCSIImpl) this.mCsi).encodeAll(asnOutputStream, Tag.CLASS_CONTEXT_SPECIFIC, _TAG_mCsi);
            if (this.smsCsi != null)
                ((SMSCSIImpl) this.smsCsi).encodeAll(asnOutputStream, Tag.CLASS_CONTEXT_SPECIFIC, _TAG_smsCsi);
            if (this.vtCsi != null)
                ((TCSIImpl) this.vtCsi).encodeAll(asnOutputStream, Tag.CLASS_CONTEXT_SPECIFIC, _TAG_vtCsi);
            if (this.tBcsmCamelTdpCriteriaList != null) {
                asnOutputStream.writeTag(Tag.CLASS_CONTEXT_SPECIFIC, false, _TAG_tBcsmCamelTdpCriteriaList);
                int pos = asnOutputStream.StartContentDefiniteLength();
            ...
            if (this.dCsi != null)
                ((DCSIImpl) this.dCsi).encodeAll(asnOutputStream, Tag.CLASS_CONTEXT_SPECIFIC, _TAG_dCsi);
