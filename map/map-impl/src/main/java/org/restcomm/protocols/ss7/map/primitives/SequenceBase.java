 ...
 *
 */
public abstract class SequenceBase implements MAPAsnPrimitive {
    ...
    protected abstract void _decode(AsnInputStream asnInputStream, int length) throws MAPParsingComponentException, IOException,
            AsnException;
