...
public class AnyTimeSubscriptionInterrogationResponseImpl extends MobilityMessageImpl implements AnyTimeSubscriptionInterrogationResponse, MAPAsnPrimitive {
    ...
    public void encodeData(AsnOutputStream asnOutputStream) throws MAPException {
        if (this.callForwardingData != null) {
            ((CallForwardingDataImpl)this.callForwardingData).encodeAll(asnOutputStream, Tag.CLASS_CONTEXT_SPECIFIC, _TAG_CALL_FORWARDING_DATA);
        }

        if (callBarringData != null) {
            ((CallBarringDataImpl)this.callBarringData).encodeAll(asnOutputStream, Tag.CLASS_CONTEXT_SPECIFIC, _TAG_CALL_BARRING_DATA);
        }
        ...
        if (this.supportedVlrCamelPhases != null) {
            ((SupportedCamelPhasesImpl)this.supportedVlrCamelPhases).encodeAll(asnOutputStream, Tag.CLASS_CONTEXT_SPECIFIC, _TAG_SUPPORTED_VLR_CAMEL_PHASES);
        }

        if (this.supportedSgsnCamelPhases != null) {
            ((SupportedCamelPhasesImpl)this.supportedSgsnCamelPhases).encodeAll(asnOutputStream, Tag.CLASS_CONTEXT_SPECIFIC, _TAG_SUPPORTED_SGSN_CAMEL_PHASES);
        }
        ...
        if (this.offeredCamel4CSIsInVlr != null) {
            ((OfferedCamel4CSIsImpl)this.offeredCamel4CSIsInVlr).encodeAll(asnOutputStream, Tag.CLASS_CONTEXT_SPECIFIC, _TAG_OFFERED_CAMEL4_CSI_IS_IN_VLR);
        }

        if (this.offeredCamel4CSIsInSgsn != null) {
            ((OfferedCamel4CSIsImpl)this.offeredCamel4CSIsInSgsn).encodeAll(asnOutputStream, Tag.CLASS_CONTEXT_SPECIFIC, _TAG_OFFERED_CAMEL4_CSI_IS_IS_SGSN);
        }
        ...
        try {
            if (this.msisdnBsList != null) {
                ...
                asnOutputStream.writeTag(Tag.CLASS_CONTEXT_SPECIFIC, false, _TAG_MSISDN_BS_LIST);
                int pos = asnOutputStream.StartContentDefiniteLength();
                for (MSISDNBS msisdnbs: this.msisdnBsList) {
                    ((MSISDNBSImpl)msisdnbs).encodeAll(asnOutputStream);
                }
                asnOutputStream.FinalizeContent(pos);
            }
        ...
        try {
            if (this.csgSubscriptionDataList != null) {
                ...
                asnOutputStream.writeTag(Tag.CLASS_CONTEXT_SPECIFIC, false, _TAG_CSG_SUBSCRIPTION_DATA_LIST);
                int pos = asnOutputStream.StartContentDefiniteLength();
                for (CSGSubscriptionData subscriptionData: this.csgSubscriptionDataList) {
                    ((CSGSubscriptionDataImpl)subscriptionData).encodeAll(asnOutputStream);
                }
                asnOutputStream.FinalizeContent(pos);
            }
        } catch (AsnException ae) {
