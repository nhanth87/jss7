...
public class MDTConfigurationImpl extends SequenceBase implements MDTConfiguration {
    ...
    public void encodeData(AsnOutputStream asnOutputStream) throws MAPException {
        ...
        try {
            ...
            asnOutputStream.writeInteger(Tag.CLASS_UNIVERSAL, Tag.ENUMERATED, this.jobType.getCode());
            ...
            if (this.reportingTrigger != null)
                ((ReportingTriggerImpl) this.reportingTrigger).encodeAll(asnOutputStream, Tag.CLASS_CONTEXT_SPECIFIC, _ID_reportingTrigger);
            if (this.reportInterval != null)
                asnOutputStream.writeInteger(Tag.CLASS_UNIVERSAL, Tag.ENUMERATED, this.reportInterval.getCode());
            if (this.reportAmount != null)
                asnOutputStream.writeInteger(Tag.CLASS_CONTEXT_SPECIFIC, _ID_reportAmount, this.reportAmount.getCode());
            if (this.eventThresholdRSRP != null)
                asnOutputStream.writeInteger(Tag.CLASS_UNIVERSAL, Tag.INTEGER, this.eventThresholdRSRP);
            if (this.eventThresholdRSRQ != null)
                asnOutputStream.writeInteger(Tag.CLASS_CONTEXT_SPECIFIC, _ID_eventThresholdRSRQ, this.eventThresholdRSRQ);
            if (this.loggingInterval != null)
                asnOutputStream.writeInteger(Tag.CLASS_CONTEXT_SPECIFIC, _ID_loggingInterval, this.loggingInterval.getCode());
            if (this.loggingDuration != null)
                asnOutputStream.writeInteger(Tag.CLASS_CONTEXT_SPECIFIC, _ID_loggingDuration, this.loggingDuration.getCode());
