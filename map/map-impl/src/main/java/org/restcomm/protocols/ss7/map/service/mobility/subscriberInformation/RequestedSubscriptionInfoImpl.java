...
public class RequestedSubscriptionInfoImpl extends SequenceBase implements RequestedSubscriptionInfo {
    ...
    public void encodeData(AsnOutputStream asnOutputStream) throws MAPException {
        if (this.ssForBSCode != null) {
            ((SSForBSCodeImpl)this.ssForBSCode).encodeAll(asnOutputStream, Tag.CLASS_CONTEXT_SPECIFIC, _ID_requested_SS_info);
        }

        try {
            if (this.isOdb) {
                asnOutputStream.writeNull(Tag.CLASS_CONTEXT_SPECIFIC, _ID_odb);
            }
        }  catch (IOException e) {
        ...
        try {
            if (this.requestedCAMELSubscriptionInfo != null) {
                asnOutputStream.writeInteger(Tag.CLASS_CONTEXT_SPECIFIC, _ID_requested_CAMEL_subscription_info, requestedCAMELSubscriptionInfo.getCode());
            }
        }  catch (IOException e) {
        ...
        try {
            if (this.isSupportedVlrCamelPhases) {
                asnOutputStream.writeNull(Tag.CLASS_CONTEXT_SPECIFIC, _ID_supported_VLR_CAMEL_phases);
            }
        }  catch (IOException e) {
        ...
        try {
            if (this.isSupportedSgsnCamelPhases) {
                asnOutputStream.writeNull(Tag.CLASS_CONTEXT_SPECIFIC, _ID_supported_SGSN_CAMEL_phases);
            }
        }  catch (IOException e) {
        ...
        if (this.extensionContainer != null) {
            ((MAPExtensionContainerImpl) this.extensionContainer).encodeAll(asnOutputStream, Tag.CLASS_CONTEXT_SPECIFIC, _ID_extension_container);
        }

        try {
            if (this.additionalRequestedCAMELSubscriptionInfo != null) {
                asnOutputStream.writeInteger(Tag.CLASS_CONTEXT_SPECIFIC, _ID_additional_requested_CAMEL_subscription_info, additionalRequestedCAMELSubscriptionInfo.getCode());
            }
        }  catch (IOException e) {
        ...
        try {
            if (this.isMsisdnBsList) {
                asnOutputStream.writeNull(Tag.CLASS_CONTEXT_SPECIFIC, _ID_msisdn_BS_list);
            }
        }  catch (IOException e) {
        ...
        try {
            if (this.isCsgSubscriptionDataRequested) {
                asnOutputStream.writeNull(Tag.CLASS_CONTEXT_SPECIFIC, _ID_csg_subscription_data_requested);
            }
        }  catch (IOException e) {
        ...
        try {
            if (this.isCwInfo) {
                asnOutputStream.writeNull(Tag.CLASS_CONTEXT_SPECIFIC, _ID_cw_info);
            }
        }  catch (IOException e) {
        ...
        try {
            if (this.isClipInfo) {
                asnOutputStream.writeNull(Tag.CLASS_CONTEXT_SPECIFIC, _ID_clip_info);
            }
        }  catch (IOException e) {
        ...
        try {
            if (this.isClirInfo) {
                asnOutputStream.writeNull(Tag.CLASS_CONTEXT_SPECIFIC, _ID_clir_info);
            }
        }  catch (IOException e) {
        ...
        try {
            if (this.isHoldInfo) {
                asnOutputStream.writeNull(Tag.CLASS_CONTEXT_SPECIFIC, _ID_hold_info);
            }
        }  catch (IOException e) {
        ...
        try {
            if (this.isEctInfo) {
                asnOutputStream.writeNull(Tag.CLASS_CONTEXT_SPECIFIC, _ID_ect_info);
            }
        }  catch (IOException e) {
