    ...
    public void encodeData(AsnOutputStream asnOutputStream) throws MAPException {
        try {
            if (this.ccbsIndex != null)
                asnOutputStream.writeInteger(Tag.CLASS_CONTEXT_SPECIFIC, _TAG_ccbsIndex, this.ccbsIndex);
            if (this.bSubscriberNumber != null)
                ((ISDNAddressStringImpl) this.bSubscriberNumber).encodeAll(asnOutputStream, Tag.CLASS_CONTEXT_SPECIFIC, _TAG_bSubscriberNumber);
            if (this.bSubscriberSubaddress != null)
                ((ISDNAddressStringImpl) this.bSubscriberSubaddress).encodeAll(asnOutputStream, Tag.CLASS_CONTEXT_SPECIFIC, _TAG_bSubscriberSubaddress);
            if (this.basicServiceCode != null) {
                asnOutputStream.writeTag(Tag.CLASS_CONTEXT_SPECIFIC, false, _TAG_basicServiceGroup);
