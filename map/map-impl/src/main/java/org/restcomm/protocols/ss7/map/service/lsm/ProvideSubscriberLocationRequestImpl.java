...
public class ProvideSubscriberLocationRequestImpl extends LsmMessageImpl implements ProvideSubscriberLocationRequest {
    ...
    public void encodeData(AsnOutputStream asnOutputStream) throws MAPException {
        ...
        if (this.lcsClientID != null) {
            // lcs-ClientID [0] LCS-ClientID OPTIONAL
            ((LCSClientIDImpl) this.lcsClientID).encodeAll(asnOutputStream, Tag.CLASS_CONTEXT_SPECIFIC, _TAG_LCS_CLIENT_ID);
        }

        if (this.privacyOverride) {
            // privacyOverride [1] NULL OPTIONAL
            try {
                asnOutputStream.writeNull(Tag.CLASS_CONTEXT_SPECIFIC, _TAG_PRIVACY_OVERRIDE);
            } catch (IOException e) {
        ...
        if (this.lcsPriority != null) {
            // lcs-Priority [6] LCS-Priority OPTIONAL,
            try {
                asnOutputStream.writeOctetString(Tag.CLASS_CONTEXT_SPECIFIC, _TAG_LCS_PRIORITY,
        ...
        if (this.lcsQoS != null) {
            // lcs-QoS [7] LCS-QoS OPTIONAL
            ((LCSQoSImpl) this.lcsQoS).encodeAll(asnOutputStream, Tag.CLASS_CONTEXT_SPECIFIC, _TAG_LCS_QOS);
        }
        ...
        if (this.supportedGADShapes != null) {
            // supportedGADShapes [9] SupportedGADShapes OPTIONAL
            ((SupportedGADShapesImpl) this.supportedGADShapes).encodeAll(asnOutputStream, Tag.CLASS_CONTEXT_SPECIFIC,
        ...
        if (this.lcsCodeword != null) {
            // lcsCodeword [12] LCSCodeword OPTIONAL,
            ((LCSCodewordImpl) this.lcsCodeword).encodeAll(asnOutputStream, Tag.CLASS_CONTEXT_SPECIFIC, _TAG_LCS_CODEWORD);
        }

        if (this.lcsPrivacyCheck != null) {
            // lcs-PrivacyCheck [13] LCS-PrivacyCheck OPTIONAL,
            ((LCSPrivacyCheckImpl) this.lcsPrivacyCheck).encodeAll(asnOutputStream, Tag.CLASS_CONTEXT_SPECIFIC, _TAG_LCS_PRIVACY_CHECK);
        }

        if (this.areaEventInfo != null) {
            // areaEventInfo [14] AreaEventInfo OPTIONAL,
            ((AreaEventInfoImpl) this.areaEventInfo).encodeAll(asnOutputStream, Tag.CLASS_CONTEXT_SPECIFIC, _TAG_AREA_EVENT_INFO);
        }
