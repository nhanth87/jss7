...
public class LCSQoSImpl implements LCSQoS, MAPAsnPrimitive {
    ...
    public void encodeData(AsnOutputStream asnOutputStream) throws MAPException {
        if (this.horizontalAccuracy != null) {
            try {
                asnOutputStream.writeOctetString(Tag.CLASS_CONTEXT_SPECIFIC, _TAG_HORIZONTAL_ACCURACY,
        ...
        if (this.verticalCoordinateRequest) {
            try {
                asnOutputStream.writeNull(Tag.CLASS_CONTEXT_SPECIFIC, _TAG_VERTICAL_COORDINATE_REQUEST);
            } catch (IOException e) {
        ...
        if (this.verticalAccuracy != null) {
            try {
                asnOutputStream.writeOctetString(Tag.CLASS_CONTEXT_SPECIFIC, _TAG_VERTICAL_ACCURACY,
        ...
        if (this.responseTime != null) {
            ((ResponseTimeImpl) this.responseTime).encodeAll(asnOutputStream, Tag.CLASS_CONTEXT_SPECIFIC, _TAG_RESPONSE_TIME);
        }
