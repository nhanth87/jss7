...
public class GPRSSubscriptionDataImpl extends SequenceBase implements GPRSSubscriptionData {
    ...
    public void encodeData(AsnOutputStream asnOutputStream) throws MAPException {
        ...
        try {
            asnOutputStream.writeTag(Tag.CLASS_CONTEXT_SPECIFIC, false, _TAG_gprsDataList);
            int pos = asnOutputStream.StartContentDefiniteLength();
            for (PDPContext pdpContext : this.gprsDataList) {
                ((PDPContextImpl) pdpContext).encodeAll(asnOutputStream);
            }
        ...
        if (this.apnOiReplacement != null)
            ((APNOIReplacementImpl) this.apnOiReplacement).encodeAll(asnOutputStream, Tag.CLASS_CONTEXT_SPECIFIC, _TAG_apnOiReplacement);
    }
