 ...
 */
public class ModificationRequestForECTInfoImpl extends SequenceBase implements ModificationRequestForECTInfo {
  ...
  public static final String _PrimitiveName = "ModificationRequestForECTInfo";

  private ExtSSStatus ssStatus;
  private ModificationInstruction modifyNotificationToCSE;
  private MAPExtensionContainer extensionContainer;

  public ModificationRequestForECTInfoImpl() {
    super(_PrimitiveName);
  }

  public ModificationRequestForECTInfoImpl(ExtSSStatus ssStatus, ModificationInstruction modifyNotificationToCSE,
