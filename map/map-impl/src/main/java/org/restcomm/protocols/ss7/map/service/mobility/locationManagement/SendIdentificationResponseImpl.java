        ...
        if (mapProtocolVersion >= 3) {
            try {
                ...
                if (this.currentSecurityContext != null) {
                    asnOutputStream.writeTag(Tag.CLASS_CONTEXT_SPECIFIC, false, _TAG_currentSecurityContext);
                    int pos = asnOutputStream.StartContentDefiniteLength();
                    ((CurrentSecurityContextImpl) this.currentSecurityContext).encodeAll(asnOutputStream);
                    asnOutputStream.FinalizeContent(pos);
