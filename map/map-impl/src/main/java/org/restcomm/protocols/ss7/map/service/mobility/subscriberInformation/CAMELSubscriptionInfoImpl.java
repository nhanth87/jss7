...
public class CAMELSubscriptionInfoImpl extends SequenceBase implements CAMELSubscriptionInfo {
    ...
    public void encodeData(AsnOutputStream asnOutputStream) throws MAPException {
        if (this.oCsi != null) {
            ((OCSIImpl)this.oCsi).encodeAll(asnOutputStream, Tag.CLASS_CONTEXT_SPECIFIC, _TAG_O_CSI);
        }
        ...
        try {
            if (this.oBcsmCamelTDPCriteriaList != null) {
                ...
                asnOutputStream.writeTag(Tag.CLASS_CONTEXT_SPECIFIC, false, _TAG_O_BSCM_CAMEL_TDP_CRITERIA_LIST);
                int pos = asnOutputStream.StartContentDefiniteLength();
                for (OBcsmCamelTdpCriteria oBcsmCamelTdpCriteria: this.oBcsmCamelTDPCriteriaList) {
                    ((OBcsmCamelTdpCriteriaImpl)oBcsmCamelTdpCriteria).encodeAll(asnOutputStream);
                }
        ...
        if (this.dCsi != null) {
            ((DCSIImpl)this.dCsi).encodeAll(asnOutputStream, Tag.CLASS_CONTEXT_SPECIFIC, _TAG_D_CSI);
        }

        if (this.tCsi != null) {
            ((TCSIImpl)this.tCsi).encodeAll(asnOutputStream, Tag.CLASS_CONTEXT_SPECIFIC, _TAG_T_CSI);
        }
        ...
        try {
            if (this.tBcsmCamelTdpCriteriaList != null) {
                ...
                asnOutputStream.writeTag(Tag.CLASS_CONTEXT_SPECIFIC, false, _TAG_T_BCSM_CAMEL_TDP_CRITERIA_LIST);
                int pos = asnOutputStream.StartContentDefiniteLength();
                for (TBcsmCamelTdpCriteria tBcsmCamelTdpCriteria: this.tBcsmCamelTdpCriteriaList) {
                    ((TBcsmCamelTdpCriteriaImpl)tBcsmCamelTdpCriteria).encodeAll(asnOutputStream);
                }
                asnOutputStream.FinalizeContent(pos);
            }
        } catch (AsnException ae) {
        ...
        if (this.vtCsi != null) {
            ((TCSIImpl)this.vtCsi).encodeAll(asnOutputStream, Tag.CLASS_CONTEXT_SPECIFIC, _TAG_VT_CSI);
        }
        ...
        try {
            if (this.vtBcsmCamelTdpCriteriaList != null) {
                ...
                asnOutputStream.writeTag(Tag.CLASS_CONTEXT_SPECIFIC, false, _TAG_VT_BCSM_CAMEL_TDP_CRITERIA_LIST);
                int pos = asnOutputStream.StartContentDefiniteLength();
                for (TBcsmCamelTdpCriteria vtBcsmCamelTdpCriteria: this.vtBcsmCamelTdpCriteriaList) {
                    ((TBcsmCamelTdpCriteriaImpl)vtBcsmCamelTdpCriteria).encodeAll(asnOutputStream);
                }
                asnOutputStream.FinalizeContent(pos);
            }
        } catch (AsnException ae) {
        ...
        if (this.tifCsi) {
            try {
                asnOutputStream.writeNull(Tag.CLASS_CONTEXT_SPECIFIC, _TAG_TIF_CSI);
            } catch (IOException e) {
        ...
        if (this.tifCsiNotificationToCSE) {
            try {
                asnOutputStream.writeNull(Tag.CLASS_CONTEXT_SPECIFIC, _TAG_TIF_CSI_NOTIFICATION_TO_CSE);
            } catch (IOException e) {
        ...
        if (this.gprsCsi != null) {
            ((GPRSCSIImpl)this.gprsCsi).encodeAll(asnOutputStream, Tag.CLASS_CONTEXT_SPECIFIC, _TAG_GPRS_CSI);
        }

        if (this.moSmsCsi != null) {
            ((SMSCSIImpl)this.moSmsCsi).encodeAll(asnOutputStream, Tag.CLASS_CONTEXT_SPECIFIC, _TAG_MO_SMS_CSI);
        }

        if (this.ssCsi != null) {
            ((SSCSIImpl)this.ssCsi).encodeAll(asnOutputStream, Tag.CLASS_CONTEXT_SPECIFIC, _TAG_SS_CSI);
        }

        if (this.mCsi != null) {
            ((MCSIImpl)this.mCsi).encodeAll(asnOutputStream, Tag.CLASS_CONTEXT_SPECIFIC, _TAG_M_CSI);
        }
        ...
        if (this.specificCSIDeletedList != null) {
            ((SpecificCSIWithdrawImpl)this.specificCSIDeletedList).encodeAll(asnOutputStream, Tag.CLASS_CONTEXT_SPECIFIC, _TAG_SPECIFIC_CSI_DELETE_LIST);
        }

        if (this.mtSmsCsi != null) {
            ((SMSCSIImpl)this.mtSmsCsi).encodeAll(asnOutputStream, Tag.CLASS_CONTEXT_SPECIFIC, _TAG_MT_SMS_CSI);
        }
        ...
        try {
            if (this.mtSmsCamelTdpCriteriaList != null) {
                ...
                asnOutputStream.writeTag(Tag.CLASS_CONTEXT_SPECIFIC, false, _TAG_MT_SMS_CAMEL_TDP_CRITERIA_LIST);
                int pos = asnOutputStream.StartContentDefiniteLength();
        ...
        if (this.mgCsi != null) {
            ((MGCSIImpl)this.mgCsi).encodeAll(asnOutputStream, Tag.CLASS_CONTEXT_SPECIFIC, _TAG_MG_CSI);
        }

        if (this.oImCsi != null) {
            ((OCSIImpl)this.oImCsi).encodeAll(asnOutputStream, Tag.CLASS_CONTEXT_SPECIFIC, _TAG_O_IM_SCI);
        }
        ...
        try {
            if (this.oImBcsmCamelTdpCriteriaList != null) {
                ...
                asnOutputStream.writeTag(Tag.CLASS_CONTEXT_SPECIFIC, false, _TAG_O_IM_BCSM_CAMEL_TDP_CRITERIA_LIST);
                int pos = asnOutputStream.StartContentDefiniteLength();
                for (OBcsmCamelTdpCriteria oImBcsmCamelTdpCriteria: this.oImBcsmCamelTdpCriteriaList) {
                    ((OBcsmCamelTdpCriteriaImpl)oImBcsmCamelTdpCriteria).encodeAll(asnOutputStream);
                }
                asnOutputStream.FinalizeContent(pos);
            }
        } catch (AsnException ae) {
        ...
        if (this.dImCsi != null) {
            ((DCSIImpl)this.dImCsi).encodeAll(asnOutputStream, Tag.CLASS_CONTEXT_SPECIFIC, _TAG_D_IM_CSI);
        }

        if (this.vtImCsi != null) {
            ((TCSIImpl)this.vtImCsi).encodeAll(asnOutputStream, Tag.CLASS_CONTEXT_SPECIFIC, _TAG_VT_IM_CSI);
        }
        ...
        try {
            if (this.vtImBcsmCamelTdpCriteriaList != null) {
                ...
                asnOutputStream.writeTag(Tag.CLASS_CONTEXT_SPECIFIC, false, _TAG_VT_IM_BCSM_CAMEL_TDP_CRITERIA_LIST);
                int pos = asnOutputStream.StartContentDefiniteLength();
                for (TBcsmCamelTdpCriteria vtImBcsmCamelTdpCriteria: this.vtImBcsmCamelTdpCriteriaList) {
                    ((TBcsmCamelTdpCriteriaImpl)vtImBcsmCamelTdpCriteria).encodeAll(asnOutputStream);
                }
                asnOutputStream.FinalizeContent(pos);
            }
        } catch (AsnException ae) {
