...
public class ConcatenatedShortMessagesIdentifierImpl implements ConcatenatedShortMessagesIdentifier {
    ...
    private int messageSegmentNumber;
     ...
     * @param messageSegmentCount Maximum number of short messages in the concatenated short message. This octet shall contain a
     ...
     * @param messageSegmentNumber Sequence number of the current short message. This octet shall contain a value in the range 0
     ...
     */
    public ConcatenatedShortMessagesIdentifierImpl(boolean referenceIs16bit, int reference, int messageSegmentCount,
    ...
    public ConcatenatedShortMessagesIdentifierImpl(byte[] encodedInformationElementData) {
        ...
        if (encodedInformationElementData.length == 3) {
            ...
            this.messageSegmentCount = encodedInformationElementData[1] & 0xFF;
            this.messageSegmentNumber = encodedInformationElementData[2] & 0xFF;
        } else {
            this.referenceIs16bit = true;
            this.reference = (encodedInformationElementData[0] & 0xFF) + ((encodedInformationElementData[1] & 0xFF) << 8);
            this.messageSegmentCount = encodedInformationElementData[2] & 0xFF;
            this.messageSegmentNumber = encodedInformationElementData[3] & 0xFF;
        }
    }
    ...
    public byte[] getEncodedInformationElementData() {
        ...
        if (this.referenceIs16bit) {
            ...
            res[2] = (byte) (this.messageSegmentCount & 0xFF);
            res[3] = (byte) (this.messageSegmentNumber & 0xFF);
        } else {
            res = new byte[3];
            res[0] = (byte) (this.reference & 0x00FF);
            res[1] = (byte) (this.messageSegmentCount & 0xFF);
            res[2] = (byte) (this.messageSegmentNumber & 0xFF);
        }
        return res;
    }
    ...
    public String toString() {
        ...
        sb.append(", messagePartsCount=");
        sb.append(this.messageSegmentCount);
        sb.append(", messagePartNumber=");
        sb.append(this.messageSegmentNumber);
        sb.append("]");
