 ...
 */
public abstract class TestHarnessUssd implements MAPDialogListener, MAPServiceSupplementaryListener, MAPServiceSmsListener {
    ...
    public void init() {
        try {
            ...
            InputStream inStreamLog4j = TestHarnessUssd.class.getResourceAsStream("/log4j.properties");
            ...
            if (inStreamLog4j != null) {
                ...
                System.out.println("log4j.properties not found on classpath, using log4j2 defaults");
            }
            ...
            try {
                // file logging is configured declaratively via log4j2.xml (programmatic log4j1 appender removed)
