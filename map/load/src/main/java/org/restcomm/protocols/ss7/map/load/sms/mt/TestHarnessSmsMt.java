 ...
 */
public abstract class TestHarnessSmsMt implements MAPDialogListener, MAPServiceSmsListener {
    ...
    protected static int SMSC_SSN = 8;
    ...
    protected static String SUCCESS_RATE = "ALL";
    ...
    public void init() {
        try {
            ...
            InputStream inStreamLog4j = TestHarnessSmsMt.class.getResourceAsStream("/log4j.properties");
