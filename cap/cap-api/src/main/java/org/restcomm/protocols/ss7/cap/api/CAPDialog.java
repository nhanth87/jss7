...
public interface CAPDialog extends Serializable {
    ...
    /**
     * This method can be called on timeout of dialog, inside {@link CAPDialogListener#onDialogTimeout(CAPDialog)} callback. If its
     ...
     *
     * @param capUserAbortReason optional - may be null
     */
