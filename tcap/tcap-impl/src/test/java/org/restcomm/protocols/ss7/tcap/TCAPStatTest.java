...
//        long i22 = ((TCAPProviderImpl)this.tcapStack2.getProvider()).getCurrentDialogsCount();
    ...
    public void variousTest() throws Exception {
        ...
        v.updateValue();
        check1.OutgoingDialogsPerApplicationContextName.put("[0, 4, 0, 0, 1, 0, 19, 2]", v);
        v = new LongValue();
        v.updateValue();
        check2.IncomingDialogsPerApplicationContextName.put("[0, 4, 0, 0, 1, 0, 19, 2]", v);
        v = new LongValue();
        v.updateValue();
        ...
        check1.TcBeginSentCount++;
        check1.InvokeSentCount += 2;
        v = check1.OutgoingDialogsPerApplicationContextName.get("[0, 4, 0, 0, 1, 0, 19, 2]");
        v.updateValue();
        v = check2.IncomingDialogsPerApplicationContextName.get("[0, 4, 0, 0, 1, 0, 19, 2]");
        v.updateValue();
    ...
    private void doSetupCounters(String camp, TCAPCounterProvider prov) {
        prov.getIncomingDialogsPerApplicationContextName(camp);
        prov.getOutgoingDialogsPerApplicationContextName(camp);
    ...
    class TCAPCounterProviderChecker {
        ...
        public Map<String, LongValue> IncomingDialogsPerApplicationContextName = new ConcurrentHashMap<String, LongValue>();
        public Map<String, LongValue> OutgoingDialogsPerApplicationContextName = new ConcurrentHashMap<String, LongValue>();
        public Map<String, LongValue> IncomingInvokesPerOperationCode = new ConcurrentHashMap<String, LongValue>();
        public Map<String, LongValue> OutgoingInvokesPerOperationCode = new ConcurrentHashMap<String, LongValue>();
        public Map<String, LongValue> OutgoingErrorsPerErrorCode = new ConcurrentHashMap<String, LongValue>();
        public Map<String, LongValue> IncomingErrorsPerErrorCode = new ConcurrentHashMap<String, LongValue>();
        public Map<String, LongValue> OutgoingRejectPerProblem = new ConcurrentHashMap<String, LongValue>();
        public Map<String, LongValue> IncomingRejectPerProblem = new ConcurrentHashMap<String, LongValue>();
        ...
        private void checkCounter(Map<String, LongValue> orig, Map<String, LongValue> check) {
        ...
        public void check(TCAPCounterProvider prov, String camp) {
            checkCounter(prov.getIncomingDialogsPerApplicationContextName(camp), IncomingDialogsPerApplicationContextName);
            checkCounter(prov.getOutgoingDialogsPerApplicationContextName(camp), OutgoingDialogsPerApplicationContextName);
