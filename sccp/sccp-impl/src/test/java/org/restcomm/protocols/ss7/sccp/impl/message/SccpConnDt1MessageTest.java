...
public class SccpConnDt1MessageTest {
    ...
    public byte[] getDataDt1() {
        return new byte[] { 0x06, 0x00, 0x00, 0x01, 0x00, 0x01, 0x05, 0x01, 0x02, 0x03, 0x04, 0x05 };
    }

    @Test(groups = { "SccpMessage", "functional.decode" })
    public void testDecode() throws Exception {
        ByteArrayInputStream buf = new ByteArrayInputStream(this.getDataDt1());
        int type = buf.read();
    ...
    public void testEncode() throws Exception {
        ...
        assertEquals(encoded.getSolidData(), this.getDataDt1());
    }
}
