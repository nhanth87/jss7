...
//                FileOutputStream fs = new FileOutputStream(Util.getTmpTestDir() + File.separator + "MsgLog.pcap", true);
    ...
    public synchronized void saveLogFile(String fileName) {
        // Debug helper: previously configured a log4j1 FileAppender to dump the test
        // log. log4j1 (PatternLayout/FileAppender/BasicConfigurator) was removed on the
        // j25 branch; this method is retained as a no-op so callers still compile.
    }
