...
public class MessageSegmentationTest {
    ...
    public void testEncode() throws Exception {
        ...
        assertEquals(res.getSegmentedData().size(), 3);
        assertTrue(Arrays.equals(res.getSegmentedData().get(0), getDataSegm1()));
        assertTrue(Arrays.equals(res.getSegmentedData().get(1), getDataSegm2()));
        assertTrue(Arrays.equals(res.getSegmentedData().get(2), getDataSegm3()));
        ...
        assertEquals(res.getEncodingResult(), EncodingResult.Success);
        assertEquals(res.getSegmentedData().size(), 3);
        assertTrue(Arrays.equals(res.getSegmentedData().get(0), getDataSegm1_S()));
        assertTrue(Arrays.equals(res.getSegmentedData().get(1), getDataSegm2_S()));
        assertTrue(Arrays.equals(res.getSegmentedData().get(2), getDataSegm3_S()));
        ...
        assertEquals(res.getEncodingResult(), EncodingResult.Success);
        assertEquals(res.getSegmentedData().size(), 2);

        // StringBuilder sb = new StringBuilder();
        // for (byte bt : res.getSegmentedData().get(2)) {
        // sb.append(", ");
        // int i1 = (bt & 0xFF);
        // if (i1 > 127)
        // sb.append("(byte)");
