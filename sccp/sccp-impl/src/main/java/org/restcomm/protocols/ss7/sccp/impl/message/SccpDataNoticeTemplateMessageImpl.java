...
public abstract class SccpDataNoticeTemplateMessageImpl extends SccpSegmentableMessageImpl {
    ...
    protected abstract boolean getSecondParameterPresent();

    protected abstract byte[] getSecondParameterData(boolean removeSPC, SccpProtocolVersion sccpProtocolVersion) throws ParseException;

    protected abstract void setSecondParameterData(int data, SccpProtocolVersion sccpProtocolVersion) throws ParseException;
    ...
    public EncodingResultData encode(SccpStackImpl sccpStackImpl, LongMessageRuleType longMessageRuleType, int maxMtp3UserDataLength, Logger logger,
        ...
        try {
            ...
            if (!this.getSecondParameterPresent())
