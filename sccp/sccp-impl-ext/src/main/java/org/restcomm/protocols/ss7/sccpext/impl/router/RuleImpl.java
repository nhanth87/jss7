 ...
 */
@JacksonXmlRootElement(localName = "ruleImpl")
...
public class RuleImpl implements Rule, Serializable {
    ...
    /** Translation method */
    @JacksonXmlProperty(localName = "paddress")
    private int primaryAddressId = 0;
    @JacksonXmlProperty(localName = "saddress")
    private int secondaryAddressId = 0;
    @JacksonXmlProperty(localName = "ncpaddress")
    ...
    @JsonIgnore
    private String[] getMaskPattern() {
        if (this.maskPattern == null && this.mask != null) {
            this.maskPattern = this.mask.split("/");
        }
    ...
    public SccpAddress translate(SccpAddress address, SccpAddress ruleAddress) {
        ...
        String translatedDigits = translateDigits(digits, getMaskPattern(), patternDigits.split(MASK_SEPARATOR),
