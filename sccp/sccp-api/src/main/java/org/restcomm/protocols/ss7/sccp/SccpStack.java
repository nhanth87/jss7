...
public interface SccpStack {
    ...
    /**
     * Returns Max available SCCP message data for all message types
     *
     * @return
     */
     ...
     *
     * @param releaseTimerDelay
     */
    void setRelTimerDelay(int releaseTimerDelay) throws Exception;
     ...
     */
    boolean isCongControl_blockingOutgoingSccpMessages();

    /**
     * @param value setting if true outgoing SCCP messages will be blocked (depending on message type, UDP messages from level N=6)
     */
    void setCongControl_blockingOutgoingSccpMessages(boolean value) throws Exception;

    /**
     * @return the first SLS configured in MTP3 destination for this SCCP stack
     */
    int getFirstSls();

    /**
     * @return the last SLS configured in MTP3 destination for this SCCP stack
     */
    int getLastSls();

    /**
     * @return the SLS mask configured in MTP3 destination for this SCCP stack
     */
    int getSlsMask();
