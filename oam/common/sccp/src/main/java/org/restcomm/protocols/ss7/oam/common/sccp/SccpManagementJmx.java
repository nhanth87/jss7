...
public class SccpManagementJmx implements SccpManagementJmxMBean, SccpManagementEventListener, AlarmMediator {
    ...
    public Ss7ExtSccpInterface getSs7ExtSccpInterface() {
        return this.wrappedSccpStack.getSs7ExtSccpInterface();
    }
    ...
    public void start() {
        ...
        RouterExt routerExt;
        Ss7ExtSccpDetailedInterface ss7ExtSccpDetailedInterface = (Ss7ExtSccpDetailedInterface) this.wrappedSccpStack
        ...
        if (ss7ExtSccpDetailedInterface != null && ss7ExtSccpDetailedInterface instanceof SccpExtModuleImpl) {
            ...
            routerExt = (RouterExtImpl) sccpExtModule.getRouterExt();
        } else {
            routerExt = null;
        }

        SccpRouterJmx sccpRouterJmx = new SccpRouterJmx(this.wrappedSccpStack.getRouter(), routerExt,
                this.wrappedSccpStack.getSccpProvider());
    ...
    public boolean isCongControl_blockingOutgoingSccpMessages() {
        return this.wrappedSccpStack.isCongControl_blockingOutgoingSccpMessages();
    }

    @Override
    public void setCongControl_blockingOutgoingSccpMessages(boolean value) throws Exception {
        this.wrappedSccpStack.setCongControl_blockingOutgoingSccpMessages(value);
    }
    ...
    public boolean isRespectPc() {
        return this.wrappedSccpStack.isRespectPc();
    }

    @Override
    public void setRespectPc(boolean value) throws Exception {
        this.wrappedSccpStack.setRespectPc(value);
    }
