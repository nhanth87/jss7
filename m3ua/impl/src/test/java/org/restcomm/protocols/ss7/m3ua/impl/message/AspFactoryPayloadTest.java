...
public class AspFactoryPayloadTest {
    ...
    @Test
    public void testSctpBundledMessages() throws Exception {
        ...
        byte[] bundled = new byte[data.length * 2];
        System.arraycopy(data, 0, bundled, 0, data.length);
        System.arraycopy(data, 0, bundled, data.length, data.length);
