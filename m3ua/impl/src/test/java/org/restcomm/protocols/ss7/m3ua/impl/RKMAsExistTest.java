...
public class RKMAsExistTest {
    ...
    public void testSingleAspInAs() throws Exception {
        ...
        assertEquals(AsState.getState(remAs1.getLocalFSM().getState().getName()), AsState.ACTIVE);
        ...
        assertEquals(serverM3uaMgmt.getRoute().size(), 2);
    ...
    private class Server {
        ...
        private void start() throws Exception {
            ...
            RoutingContext rc1 = factory.createRoutingContext(new long[] { 100l });
            ...
            serverM3uaMgmt.addRoute(123, 1, 1, "server-testas2");
            serverM3uaMgmt.startAsp("server-testasp");
        }

        public void stop() throws Exception {
            serverM3uaMgmt.stopAsp("server-testasp");
            serverM3uaMgmt.removeRoute(123, -1, -1, "server-testas1");
            serverM3uaMgmt.unassignAspFromAs("server-testas1", "server-testasp");
            serverM3uaMgmt.destroyAspFactory("server-testasp");
            serverM3uaMgmt.destroyAs("server-testas1");
