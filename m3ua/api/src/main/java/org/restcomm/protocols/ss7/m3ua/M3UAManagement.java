...
public interface M3UAManagement {
     ...
     * @param routingContext Optional {@link RoutingContext}
     * @param trafficModeType Optional {@link TrafficModeType}.
     * @param minAspActiveForLoadbalance Minimum {@link Asp} that should be ACTIVE before payload can be transferred. This is
     *        used only if {@link TrafficModeType} is Loadshare.
     * @param networkAppearance Optional {@link NetworkAppearance}.
     ...
     * @throws Exception
     */
    AspFactory createAspFactory(String aspName, String associationName, long aspId, boolean isHeartBeatEnabled) throws Exception;
    ...
    long getStatisticsTaskDelay();

    void setStatisticsTaskDelay(long val) throws Exception;

    long getStatisticsTaskPeriod();

    void setStatisticsTaskPeriod(long statisticsTaskPeriod) throws Exception;
