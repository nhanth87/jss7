...
public class TestPsiServerMan extends TesterBase implements TestPsiServerManMBean, Stoppable, MAPServiceMobilityListener, MAPServiceSmsListener, MAPServiceCallHandlingListener {
  ...
  public void onSendRoutingInfoForSMRequest(SendRoutingInfoForSMRequest sendRoutingInforForSMRequest) {
    ...
    LocationInfoWithLMSI locationInfoWithLMSI  = mapProvider.getMAPParameterFactory().createLocationInfoWithLMSI(networkNodeNumber, lmsi, mapExtensionContainer, false, additionalNumber, null, null, null, null, false, null, null, null, null, false, false);
        ...
        case PSIReaction.VAL_RETURN_SUCCESS:
          ...
          try {
            ...
            subscriberInfo = mapProvider.getMAPParameterFactory().createSubscriberInfo(locationInformation, subscriberState, extensionContainer,
                locationInformationGPRS, psSubscriberState, imei, msClassmark2, gprsMSClass, mnpInfoRes, null, null, null, null, null, null, null, null);
  ...
  @Override
  public void onAnyTimeModificationRequest(org.restcomm.protocols.ss7.map.api.service.mobility.subscriberInformation.AnyTimeModificationRequest request) {

  }

  public void onAnyTimeModificationResponse(org.restcomm.protocols.ss7.map.api.service.mobility.subscriberInformation.AnyTimeModificationResponse response) {
