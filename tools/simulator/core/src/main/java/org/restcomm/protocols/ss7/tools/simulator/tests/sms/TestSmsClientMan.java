...
public class TestSmsClientMan extends TesterBase implements TestSmsClientManMBean, Stoppable, MAPDialogListener,
    ...
    private String doAlertServiceCentre(String destIsdnNumber, String serviceCentreAddr) {
        ...
        try {
            ...
            curDialog.addAlertServiceCentreRequest(msisdn, serviceCentreAddressDA, null, null, null, null, null, null, null, null, null, null);
            curDialog.send();
    ...
    public void onSendRoutingInfoForSMRequest(SendRoutingInfoForSMRequest ind) {
        ...
        try {
            ...
            case SRIReaction.VAL_RETURN_SUCCESS:
                li = mapProvider.getMAPParameterFactory().createLocationInfoWithLMSI(networkNodeNumber, null, null, false, null, null, null, null, null, false, null, null, null, null, false, false);
            ...
            case SRIReaction.VAL_RETURN_SUCCESS_WITH_LMSI:
                ...
                li = mapProvider.getMAPParameterFactory().createLocationInfoWithLMSI(networkNodeNumber, lmsi, null, false, null, null, null, null, null, false, null, null, null, null, false, false);
                curDialog.addSendRoutingInfoForSMResponse(invokeId, imsi, li, null, null, null);
