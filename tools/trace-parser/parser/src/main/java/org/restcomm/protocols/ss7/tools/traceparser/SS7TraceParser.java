...
//    private Map<String, AddrData> addressLst = new ConcurrentHashMap<String, AddrData>();
    ...
    public void run() {
        ...
        try {
            ...
            if (this.par.getParseProtocol() == ParseProtocol.Map || this.par.getParseProtocol() == ParseProtocol.Cap) {
                ...
                tcapCntProv.getOutgoingDialogsPerApplicationContextName("a1");
                tcapCntProv.getIncomingDialogsPerApplicationContextName("a1");
    ...
    public String getStatisticData() {
        ...
        if (this.tcapCntProv != null) {
            ...
            this.uppendStringLongPull(sb, this.tcapCntProv.getIncomingDialogsPerApplicationContextName("a1"), "IncomingDialogsPerApplicationContextName");
    ...
    private void setFinishedState(String errorMessage) {
        ...
        if (this.par.getMessageChainFilePath() != null) {
            ...
            Map<Long, DialogMessageChain> lst11 = new ConcurrentHashMap<Long, DialogMessageChain>();
            ...
            Map<DialogMessageChain, DialogMessageChain> lst2 = new ConcurrentHashMap<DialogMessageChain, DialogMessageChain>();
            try {
    ...
    public void onMessage(SccpDataMessageImpl message, int seqControl) {
        ...
        try {
            ...
            if (this.curTcapDialog == null || this.curTcapDialog.getPreviewDialogData() == null
                    || this.curTcapDialog.getPreviewDialogData().getUpperDialog() == null) {
                return;
            }
...
//        res.cnt++;
     ...
     *
     * @see
     * org.restcomm.protocols.ss7.map.api.service.mobility.MAPServiceMobilityListener#onAnyTimeInterrogationRequest(org.mobicents
     ...
     *
     * @see
     * org.restcomm.protocols.ss7.map.api.service.mobility.MAPServiceMobilityListener#onAnyTimeInterrogationResponse(org.mobicents
